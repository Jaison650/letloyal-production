...
export default function MerchantTermsPage() {
  return (
    <LegalLayout title="Merchant Terms of Service" updated="Last updated: July 2026">
      <section>
        <h2>1. Acceptance</h2>
      ...
      <section>
        <h2>3. Customer Data &amp; DPDP Act 2023</h2>
      ...
      <section>
        <h2>7. Contact</h2>
        <p>Questions about these terms? Email <a href="mailto:hello@letloyal.com">hello@letloyal.com</a>.</p>
      </section>
    </LegalLayout>
  );
}
