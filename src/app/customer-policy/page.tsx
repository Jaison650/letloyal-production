...
export default function CustomerPolicyPage() {
  return (
    <LegalLayout title="Customer Privacy Policy" updated="Last updated: July 2026">
      <section>
      ...
      <section>
        ...
        <p className="mt-3">To exercise any of these rights, use the &quot;Delete My Account&quot; option in your My Rewards page, or contact us at <a href="mailto:hello@letloyal.com">hello@letloyal.com</a>.</p>
      </section>
      <section>
        <h2>5. Analytics Consent</h2>
