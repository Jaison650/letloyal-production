        ...
        <div className="space-y-8 text-text-medium leading-relaxed">
          ...
          <section>
            ...
            <p>
              ...
              should be directed to <a href="mailto:hello@letloyal.com" className="text-primary hover:underline">hello@letloyal.com</a>.
            </p>
          </section>
          <section>
            <h2 className="font-jakarta font-bold text-xl text-text-dark mb-3">8. Contact</h2>
            <p>Questions: <a href="mailto:hello@letloyal.com" className="text-primary hover:underline">hello@letloyal.com</a></p>
          </section>
        </div>
      </main>
    </div>
